...
2. **B, 0:40–1:30.** Карта по коленам в режиме «Структура» → переключение на «Деньги курьеров» → ползунок Δ до 2 дней: «При Δ ≤ 2 дня хронологически возможный маршрут от seed есть у 702 из 2167 не-seed узлов (32,40%). Это проверка временной совместимости маршрута; она не доказывает происхождение средств».
