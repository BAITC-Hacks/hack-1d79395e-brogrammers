...
Ниже — результаты чистого запуска A6. B пометил свою часть как готовую к финалу; объединение в `main` ожидает команды пользователя «финал». B6 проверит чистый `main` после публикации.
